package com.example.reactividadtaller.controller;

import com.example.reactividadtaller.business.BankService;
...
public class BankController {
    ...
    public Mono<String> createCustomer(@RequestBody CustomerProfile customer) {
        return bankService.createCustomerProfile(customer);
    }
